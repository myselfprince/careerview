...
const overviewData = [
  { label: "Admission Name", value: "Uttar Pradesh MBBS College Admission {process.env.NEXT_PUBLIC_YEAR}" },
  ...
  { label: "Entrance Exam", value: "NEET UG {process.env.NEXT_PUBLIC_YEAR} (Conducted by NTA)" },
...
const faqs = [
  {
    question: "What are the eligibility criteria for UP MBBS Admissions {process.env.NEXT_PUBLIC_YEAR}?",
    answer: "Aspirants must have successfully qualified the NEET UG {process.env.NEXT_PUBLIC_YEAR} examination. Additionally, they must have completed their 10+2 (or equivalent) with Physics, Chemistry, and Biology, securing a minimum aggregate of 50% for General categories and 40% for reserved categories (SC/ST/OBC)."
  },
  {
  ...
  {
    question: "When is the Uttar Pradesh NEET counseling expected to commence for {process.env.NEXT_PUBLIC_YEAR}?",
    answer: "Based on previous trends, the UPDGME is expected to initiate Round 1 of the state counseling in July {process.env.NEXT_PUBLIC_YEAR}, followed by Round 2 in August {process.env.NEXT_PUBLIC_YEAR}. Keep an eye on the {process.env.NEXT_PUBLIC_BRAND_NAME} portal for exact date announcements."
  }
];
...
export default function UPMbbsCollegesPage() {
  return (
    <div className="bg-gray-50 min-h-screen font-sans text-gray-800">
      <Head>
        <title>Top MBBS Colleges in Uttar Pradesh {process.env.NEXT_PUBLIC_YEAR} | {process.env.NEXT_PUBLIC_BRAND_NAME}</title>
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-6 space-y-6">
            ...
            {/* <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6">
              ...
              <p className="text-sm text-gray-500 mb-6">Subscribe for Latest NEET {process.env.NEXT_PUBLIC_YEAR} Counseling Updates, Fees, & Cutoffs.</p>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl shadow-sm border border-blue-200 p-6 text-center">
              ...
              <p className="text-sm text-blue-800 mb-6">Talk to our {process.env.NEXT_PUBLIC_BRAND_NAME} experts and secure admission in top medical universities.</p>
              
              <a href="tel:{process.env.NEXT_PUBLIC_PHONE}" className="flex items-center justify-center bg-white text-blue-700 font-bold py-3 px-4 rounded-lg shadow-sm border border-blue-300 hover:bg-blue-50 transition mb-3">
